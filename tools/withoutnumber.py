...
def process_png_folders(input_root, output_root):
    ...
    for file_name in os.listdir(input_root):
        ...
        output_file = os.path.join(output_root, f"{file_name}")
...
# 指定要操作的文件夹路径
input_root = r"W:\python\EWD\resource\resource_test\result"  # 替换为你的输入文件夹路径
output_root = r"W:\python\EWD\resource\resource_test\raw"  # 替换为你的输出文件夹路径
